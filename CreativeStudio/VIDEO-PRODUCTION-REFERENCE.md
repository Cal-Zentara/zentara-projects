# Video Production Reference — CreativeStudio

This is the full production reference for CreativeStudio. It is the detail moved out of `CLAUDE.md` so the main rules file stays lean. **Read this before making any video.** The hard rules and safety rules still live in `CLAUDE.md` — this file is the craft detail, workflow steps, troubleshooting, and account info.
